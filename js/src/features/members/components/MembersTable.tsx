...
import { AdminActivationToggle } from "@/features/members/components/AdminActivationToggle";
import {
  Alert,
  Anchor,
  Badge,
            ...
            <Table.Tbody>
              {members.map((member) => (
                <Table.Tr key={member.id}>
                  ...
                  <Table.Td>
                    <Anchor component={Link} to={`/admin/members/${member.id}`}>
                      View
                    </Anchor>
                  </Table.Td>
                  <Table.Td>
                    <AdminActivationToggle member={member} />
                  </Table.Td>
                </Table.Tr>
              ))}
            </Table.Tbody>
