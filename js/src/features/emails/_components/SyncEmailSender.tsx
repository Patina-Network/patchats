...
export function SyncEmailSender({
    ...
    modals.openConfirmModal({
      ...
      children: (
        <Text size="sm">
          ...
          {request?.messages.length === 1 ? "" : "s"} synchronously. Emails will
          be sent immediately. Please do not leave the page until all email have
          been marked as sent.
        </Text>
      ),
  ...
  return (
    <Flex>
      <Tooltip
        position="right"
        label="Emails will be sent immediately. Please do not leave the page until all email have been marked as sent."
      >
        <Button
          fullWidth
        ...
        >
          Send Synchronous Emails (immediately sends emails)
        </Button>
      </Tooltip>
    </Flex>
  );
